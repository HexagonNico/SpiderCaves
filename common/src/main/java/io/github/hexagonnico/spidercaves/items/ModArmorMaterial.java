...
public class ModArmorMaterial implements ArmorMaterial {
    ...
    public static final ModArmorMaterial SPIDER_ARMOR = new ModArmorMaterial("spider", new StatsMap(195, 240, 225, 165), new StatsMap(2, 5, 4, 1), 17, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0f, 0.0f, () -> Ingredient.of(SpiderCaves.SPIDER_FANG.get()));
